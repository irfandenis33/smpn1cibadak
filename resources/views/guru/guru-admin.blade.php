                        ...
                        <div class="modal-content">
                          ...
                          <form>
                              <div class="form-group">
                                  ...
                                  <input type="text" name="nip" class="form-control mb-2" id="exampleFormControlInput1" placeholder="NIP">
                                  <input type="text" name="pelajaran" class="form-control mb-2" id="exampleFormControlInput1" placeholder="Pelajaran">
                              </div>
                          </div>
