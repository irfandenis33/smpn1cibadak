...
<html lang="en">
  <head>
    ...
    <title>Kontak - SMP Negeri 1 Cibadak</title>
  </head>
  <body>
    ...
    <section id="judul-kontak" class="judul-kontak">
      <div class="container mt-4">
        ...
        <div class="row">
          <div class="col-lg-7 mt-3">
            <form action="kontak/tambahkontak" method="POST">
            {{csrf_field()}}
                <div class="form-group">
                    <input type="text" name="nama" class="form-control mb-2" id="exampleFormControlInput1" placeholder="Nama">
                    <input type="text" name="email" class="form-control mb-2" id="exampleFormControlInput1" placeholder="Email">
                    <input type="text" name="telepon" class="form-control mb-2" id="exampleFormControlInput1" placeholder="No Telepon">
                </div>
                    <div class="form-group">
                    <textarea class="form-control mb-2" name="pesan" id="exampleFormControlTextarea1" rows="3" placeholder="Isi Pesan"></textarea>
                </div>
